...
- **Test suite**: `node server/tests/logic-test.js` (22 tests) and `node server/tests/render-test.js` (10 visual PNG scenarios)
...
session_messages(channel_id, date, message_id, started_at, last_active_at)
  -- started_at/last_active_at drive 4h room expiry; resetRoom() blanks message_id and resets both timestamps
